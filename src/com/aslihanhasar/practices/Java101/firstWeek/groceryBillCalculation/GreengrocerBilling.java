package com.aslihanhasar.practices.Java101.firstWeek.groceryBillCalculation;
...
public class GreengrocerBilling {
    public static void main(String[] args) {
        ...
        totalPrice = (kgPear * pricePear) + (kgApple * priceApple) + (kgTomato * priceTomato)
                + (kgBanana * priceBanana) + (kgEggplant * priceEggplant);
